...
const Cart = () => {
  return (
    <div>
      <div className="w-full flex flex-col lg:flex-row justify-between items-start p-8">
        ...
        <div className="w-full lg:w-2/3">
          <div className="border-b border-[#F9F1E7] pb-4 bg-[#F9F1E7]">
            <div className="grid grid-cols-4 text-center font-bold text-lg py-4">
      ...
      {/* Customer Care */}
      <div className="h-auto w-full bg-[#FAF3EA] flex flex-col md:flex-row justify-around items-center py-10 mt-24 gap-6">
        {/* Column 1 */}
        <div className="flex flex-col items-center text-center space-y-2 max-w-[200px]">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="font-bold text-lg md:text-xl">High Quality</h3>
          </div>
        ...
        <div className="flex flex-col items-center text-center space-y-2 max-w-[200px]">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="font-bold text-lg md:text-xl">Warranty Protection</h3>
          </div>
        ...
        <div className="flex flex-col items-center text-center space-y-2 max-w-[200px]">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="font-bold text-lg md:text-xl">24 / 7 Support</h3>
          </div>
